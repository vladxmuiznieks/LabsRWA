...
//appending a div to a body with the inner text of div showing how many cats there are on the page
const body = document.body
const div = document.createElement('div');
body.append(div);
div.innerText = "There are " + imgs.length + " cats on this page.";

//creating a new element and appending it to the div
const strong = document.createElement('strong');
strong.innerText = "Cats are awesome.";
div.append(strong);

//changing attributes of the div
console.log(div.setAttribute("style", "color: red; font-size: 20px;"));
